...
<div class="about-img clearfix"></div>
...
<div class="big-red-capital clearfix">D</div>
...
<div class="big-red-capital very-big-font">“</div>
<blockquote class="clearfix">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas. Sed lectus nulla, bibendum at vulputate sit amet, tincidunt volutpat lorem. Mae trenas in magna mollis lectus lacinia mollis. Donec sit amet volutpat lorem. Du tristique porta aliquam. Curabitur sagittis tincidunt erat, quis hendrerit nibh iaculis vitae. Pellentesque ultric nisl quis odio posuere facilisis. In ut felis erat, ac laoreet orci donec sed nulla at sit amet.</blockquote>
<p class="col-2 column">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas. Sed lectus nulla, bibendum at vulputate sit amet, tincidunt volutpat lorem.</p>
<p class="col-2 column last-col">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas. Sed lectus nulla, bibendum at vulputate sit amet, tincidunt volutpat lorem.</p>
<p class="col-3 column">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas.</p>
<p class="col-3 column">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas.</p>
<p class="col-3 column last-col clearfix">Quisque mollis, sem id laoreet pretium, lectus elit molestie urna, id tristique risus ante at est. Sed pretium metus sit amet erat blandit vitae pulvinar lorem egestas.</p>
<div class="button-container">
	<a href="#" class="button-green">Button Text</a>
	<a href="#" class="button-grey">Button Text</a>
	<a href="#" class="button-blue">Button Text</a>
	<a href="#" class="button-orange">Button Text</a>
	<a href="#" class="button-purple">Button Text</a>
	<a href="#" class="button-red">Button Text</a>
	<a href="#" class="button-ligh-blue">Button Text</a>
</div>
<div class="green-alert">Alert Text</div>
<div class="red-alert">Alert Text</div>
<div class="yellow-alert">Alert Text</div>
<div class="blue-alert">Alert Text</div>